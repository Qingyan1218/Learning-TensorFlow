...
history = model.fit(train_images1, train_labels1, epochs=5)
...
history1 = model1.fit(train_images, train_labels, epochs=5,
                    validation_data=(test_images, test_labels))
...
history3 = model3.fit(train_images, train_labels, epochs=5,
                    validation_data=(test_images, test_labels))
...
history4 = model4.fit(train_images, train_labels, epochs=5,
                    validation_data=(test_images, test_labels))
...
history5 = model5.fit(train_images, train_labels, epochs=5,
                    validation_data=(test_images, test_labels))
...
history6 = model6.fit(train_images, train_labels, epochs=5,
                    validation_data=(test_images, test_labels))
...
history7 = model7.fit(train_images, train_labels, epochs=5,
                    validation_data=(test_images, test_labels))
...
history = model4.fit(train_images, train_labels, epochs=5, initial_epoch=0,
                    validation_data=(test_images, test_labels))
